...
#define ACS7XX_SENSITIVITY_DEFAULT  0.026 //Sensitivity of the sensor in V/A
#define ACS7XX_FACTOR_VALUE 3.3
#define BOARD_ADC_DEPTH 4095 // 10bits: 1024.0, 12bits: 4096.0, 14bits: 16384.0


#define N_Samples_CALIB 500
#define N_Samples_INST_CURRENT 500
#define N_Samples_POWER 500
